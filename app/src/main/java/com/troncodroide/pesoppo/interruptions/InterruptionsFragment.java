 ...
 * {@link InterruptionsFragment.OnInterruptionsEventListener} interface
 * to handle interaction events.
 * Use the {@link InterruptionsFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class InterruptionsFragment extends DialogFragment {
    ...
    public static InterruptionsFragment newInstance(String param) {
        InterruptionsFragment fragment = new InterruptionsFragment();
        Bundle args = new Bundle();
        args.putString(Interrupcion.class.getName(), param);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_interruptions, container, false);
    }
